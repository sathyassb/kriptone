...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        EmailSent _emailSent = new EmailSent();
        ...
        var emailSent = _emailSent.GetAll(userNames, ddlMachineName.SelectedValue, filterFromDate.ToString("yyyy-MM-dd"), filterToDate.ToString("yyyy-MM-dd"));
