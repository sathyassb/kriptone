...
public partial class _Default : System.Web.UI.Page
{
    ...
    private void idLoadDefaultDates()
    {
        txtDateFrom.Text = txtDateTo.Text = DateTime.Now.ToString("yyyy-MM-dd"); 
    }
    ...
    {
        FileShadows _obj = new FileShadows();
        ...
        var obj = _obj.GetAll(userNames, ddlMachineName.SelectedValue, filterFromDate.ToString("yyyy-MM-dd"), filterToDate.ToString("yyyy-MM-dd"));
        rptUser.DataSource = obj;
        rptUser.DataBind();
